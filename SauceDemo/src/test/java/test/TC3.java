...
public class TC3 extends BaseTest {
	...
	public void setup() {
		...
		htmlReporter = new ExtentHtmlReporter(
				"C:\\Users\\John Erick\\Documents\\GitHub\\SauceDemo\\test-output\\ExtentReports//TC3.1-TC3.5.html");
		extent = new ExtentReports();
		extent.attachReporter(htmlReporter);
		logger = extent.createTest("TC3.1 - 3.5", "Single Data Testing");
		extent.flush();
	}
	...
	public void validateOrder() {
		if (cartPage.validateCartPageObjects(1) == true) {
			logger.log(Status.PASS, "User is able to view the selected product in Cart Page");
			extent.flush();
		} else {
			logger.log(Status.FAIL, "User is cannot view the selected product in Cart Page");
			extent.flush();
		}
	}
	...
	public void fllInCheckoutInfo() {
		checkoutInfoPage.fillInCheckoutInfo("Tester1", "Testing", "1111");
